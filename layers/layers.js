...
lyr_Buffered_4.set('fieldLabels', {'fid': 'no label', 'Name': 'hidden field', 'description': 'hidden field', 'timestamp': 'header label - always visible', 'begin': 'inline label - visible with data', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'inline label - always visible', 'drawOrder': 'no label', 'icon': 'no label', });
